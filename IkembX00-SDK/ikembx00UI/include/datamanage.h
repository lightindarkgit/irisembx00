...
private slots:
    ...
    void on_box_personInfo_clicked(bool checked);

    void on_box_irisData_clicked(bool checked);

    void on_box_identRec_clicked(bool checked);

    void on_box_facePhoto_clicked(bool checked);
