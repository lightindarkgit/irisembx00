...
void* CAPIBase::ThreadMain(IN CAPIBase* pParam)
{
    ...
    time_t lt;
    char cTimeNameLeft[200];
    char cTimeNameRight[200];
    static int n=0;
#endif
    //////////////////////////////////////
...
//            funResult = pParam->_serialDistance->Send(g_adCMD, 4);
//            if(E_ALGAPI_OK != funResult)
//            {
//                continue;
//            }
            ...
            sprintf(cTimeNameLeft,"/home/fpc/IKEMB/IKEmbX00/03 Code/ikembx00UI/capimg/BeforBig%02d_%02d_%02d_%02d_%02d_%04ld.ppm",ptmNowTime->tm_mon+1,ptmNowTime->tm_mday,ptmNowTime->tm_hour,ptmNowTime->tm_min, ptmNowTime->tm_sec,tv_NowTime.tv_usec);
            funResult = SaveGrayPPMFile(cTimeNameLeft, pParam->_pCapImg, g_constIrisImgWidth, g_constIrisImgHeight);
#endif
            /////////////////////////
            ...
            //if( n < 30 )
            {
                sprintf(cTimeNameLeft,"/home/fpc/IKEMB/IKEmbX00/03 Code/ikembx00UI/capimg/AfterBig%02d_%02d_%02d_%02d_%02d_%04ld.ppm",ptmNowTime->tm_mon+1,ptmNowTime->tm_mday,ptmNowTime->tm_hour,ptmNowTime->tm_min, ptmNowTime->tm_sec,tv_NowTime.tv_usec);
                funResult = SaveGrayPPMFile(cTimeNameLeft, pParam->_pCapImg, g_constIrisImgWidth, g_constIrisImgHeight);

                sprintf(cTimeNameLeft,"/home/fpc/IKEMB/IKEmbX00/03 Code/ikembx00UI/capimg/Left%02d_%02d_%02d_%02d_%02d_%04ld.ppm",ptmNowTime->tm_mon+1,ptmNowTime->tm_mday,ptmNowTime->tm_hour,ptmNowTime->tm_min, ptmNowTime->tm_sec,tv_NowTime.tv_usec);
                funResult = SaveGrayPPMFile(cTimeNameLeft, pParam->_leftCurImg.imageData, g_constIKImgWidth, g_constIKImgHeight);

                sprintf(cTimeNameRight,"/home/fpc/IKEMB/IKEmbX00/03 Code/ikembx00UI/capimg/Right%02d_%02d_%02d_%02d_%02d_%04ld.ppm",ptmNowTime->tm_mon+1,ptmNowTime->tm_mday,ptmNowTime->tm_hour,ptmNowTime->tm_min, ptmNowTime->tm_sec,tv_NowTime.tv_usec);
                funResult = SaveGrayPPMFile(cTimeNameRight, pParam->_rightCurImg.imageData, g_constIKImgWidth, g_constIKImgHeight);
            }
...
//                memcpy(pParam->_pSwapImg, pParam->_pCapImg, g_constIrisImgSize);
                ConvertRaw2Bmp(pParam->_pSwapImg, pParam->_pCapImg, g_constIrisImgHeight, g_constIrisImgWidth);
                ...
                //控制红外灯
//                if( 0 == (imgInformCount % g_constImgNumToSetLED) )
//                {
//                    if( (g_distanceValue < g_constDistanceNoPersonValue) && (false == g_isLEDOn) )
//                    {
//                        //有人并且红外灯处于关闭状态，则打开红外灯
////                        qWarning("send open led CMD");
//                        pParam->_serialDistance->Send(g_redAllOnCMD, 4);
//                        g_isLEDOn = true;
//                    }
//                    else if( (g_distanceValue >= g_constDistanceNoPersonValue) && g_isLEDOn )
//                    {
//                        //无人且红外灯处于打开状态，则关闭红外灯
////                        qWarning("send off led CMD");
//                        pParam->_serialDistance->Send(g_redAllOffCMD, 4);
//                        g_isLEDOn = false;
//                    }
//                }
