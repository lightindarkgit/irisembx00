...
int TypeConvert::ConvertPersonDown(const PersonBase &from,Person &to)
{
	...
	//strcpy(&to.name,from.PersonName)
	// to.name = from.PersonName;
	//    std::cout << "From Name<QString::fromUtf16>: " << QString::fromUtf16((ushort*)from.PersonName).toStdString() << std::endl
	//              << "From Name<QString::fromLocal8Bit>: " << QString::fromLocal8Bit(from.PersonName).toStdString() << std::endl
	//              << "From Name<QString::fromWCharArray>: " << QString::fromWCharArray((wchar_t*)from.PersonName).toStdString() << std::endl
	//              << "From Name<QString::fromUtf8>: " << QString::fromUtf8(from.PersonName).toStdString() << std::endl
	//              << "\t To name: " << to.name << std::endl;
