...
public:
    ...
    void onInteractionStatus(bool flag)//返回识别
    {
...
// add by hatao 2015.04.22
class WeatherEvent:public QObject
{
     Q_OBJECT
public:
    void SetWeatherInfo(QString strLine)
    {
        emit sigWeatherInfoUpdate(strLine);
    }
signals:
    void sigWeatherInfoUpdate(QString strLine);
...
public:
  ...
  *****************************************************************************/
  ...
  {
      Q_UNUSED(witchPic); //Added By:Wang.L@20151015
