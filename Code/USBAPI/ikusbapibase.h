...
enum EndPointTransferType{EndPointIntr =(1 | LIBUSB_ENDPOINT_IN),
                          EndPointINData =(2 | LIBUSB_ENDPOINT_IN),
                          EndPointOUtData =(6 | LIBUSB_ENDPOINT_OUT),
...
public:
    ...
    IkUSBEndPoint(libusb_device_handle *handle=nullptr,TransferDirType dirType = DirFromDevice);
    ~IkUSBEndPoint();
...
protected:
    ...
    //回调Out函数
    static void TransferResultCallBackOut(libusb_transfer *transfer);
...
protected:
    ...
    EndPointTransferType   _transferType;
    //端点描述
...
{
public:
    IkBulkEndPoint(libusb_device_handle *handle=nullptr,TransferDirType dirType = DirFromDevice);
