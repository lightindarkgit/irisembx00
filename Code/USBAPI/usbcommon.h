...
#define E_NO_TRANSFER_ERROR      20007  /*传输设备无法获取数据，需要关闭设备重新打开*/
#define E_TIME_OVER  20008  /*超时*/
...
typedef enum {
    ...
    UsbStringMaxlen=256,
    BufsizeUport=2048,
    ImageWidth = 1280,//2048
    ImageHeight= 480,//704
    TransBufferSize  =ImageWidth*ImageHeight,
    PreviewImageSize = ImageWidth / 2 * ImageHeight,
...
struct EyeRect:Position,RectSize<uint8_t>
{
